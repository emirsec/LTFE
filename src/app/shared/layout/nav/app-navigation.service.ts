    ...
    getMenu(): AppMenu {
        return new AppMenu('MainMenu', 'MainMenu', [
            ...
            new AppMenuItem(
                ...
                [],
                [
                    new AppMenuItem('IM Dashboard','','flaticon-map','/app/main/incident-management'),
                    new AppMenuItem('Incident Management Dashboard','','flaticon-map','/app/main/incident-management'),
                ]
            ),
